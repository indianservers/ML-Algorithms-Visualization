...
export default function RegressionMetricsApprovedPage() {
  ...
  return (
    <div className="rm-page">
      ...
      <main className={`rm-main${layout}`}>
        {lesson && <LabLessonPanel tab={tab} route="/ml/evaluation/regression-metrics" />}
        <section className={`rm-plots${panel("Visualize", "Train")}`}>
