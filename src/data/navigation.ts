...
export const navigationData: NavCategory[] = [
  ...
  },
  {
    ...
    icon: 'FlaskConical',
    items: [
      { label: 'Experiment Workspace', route: '/ml/lab/experiment-workspace', badge: 'Browser Trainable' },
      { label: 'Model Zoo', route: '/ml/lab/model-zoo', badge: 'Browser Trainable' },
      { label: 'AutoML Assistant', route: '/ml/lab/automl-assistant', badge: 'Advanced' },
      { label: 'Training Visualizations', route: '/ml/lab/training-visualizations', badge: 'Browser Trainable' },
      { label: 'Inference Playground', route: '/ml/lab/inference-playground', badge: 'Browser Inference' },
      { label: 'Model Comparison Dashboard', route: '/ml/lab/model-comparison-dashboard', badge: 'Browser Inference' },
      { label: 'Explainability Center', route: '/ml/lab/explainability-center', badge: 'Advanced' },
      { label: 'Dataset Intelligence', route: '/ml/lab/dataset-intelligence', badge: 'Advanced' },
      { label: 'Tuning Engine', route: '/ml/lab/tuning-engine', badge: 'Advanced' },
